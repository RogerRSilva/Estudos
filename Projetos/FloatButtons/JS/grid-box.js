...
function adicionarConteudo(divId, texto, caminhoImagem, largura, altura) {
    ...
    if (div) {
        ...
        document.addEventListener('DOMContentLoaded', function () {
            var limiteCaracteres = 350; // limite de caracteres
        ...
        //torna a div existente pai da div que possui o texto
...
//adiciona todo o conteúdo no campo flex com titulo
function adicionarConteudoComTitulo(divId, titulo, texto, caminhoImagem, largura, altura) {
    var div = document.getElementById(divId);
    if (div) {
        // Criar um elemento com a classe que estiliza os textos e depois um elemento de parágrafo
        var containerTitulo = document.createElement("div");
        containerTitulo.setAttribute("class", "container-titulo");
        var tituloText = document.createElement("p");
        tituloText.textContent = titulo;
        ...
        //Torna a div existente pai do container de titulo, de texto e de imagem
        div.appendChild(containerTitulo);
        containerTitulo.appendChild(tituloText);
        div.appendChild(containerTexto);
        containerTexto.appendChild(paragrafo);
